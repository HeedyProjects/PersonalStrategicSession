const LocalizedStrings = {
  ...
  ru: {
    ...
    problemSteps: {
      ...
      step3Header: 'Почему ты этого хочешь? ',
      step3TitleGoal: 'Почему для тебя важно достичь этой цели? ',
      step3TitleProblem: 'Почему ты хочешь решить эту проблему? ',
    ...
    futureSteps: {
      ...
      step4Header: 'Почему тебе удастся это сделать? ',
      step4Title:
