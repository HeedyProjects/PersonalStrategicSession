const LocalizedStrings = {
  en: {
    ...
    futureSteps: {
      ...
      step2Header: 'What do you want to agit chive?',
      step2Title:
  ...
  ru: {
    ...
    problemSteps: {
      ...
      step2Title:
        ...
        step3TitleProblem:
        ' Что ты будешь делать, чтобы справиться с проблемой? ',
    ...
    futureSteps: {
      step1Header:
        ' Предствь, как будет выглядеть твоё будущее, когда ты добьёшься своей цели? ',
      step1Title:
    ...
    planSteps: {
      ...
      step2Header: ' Что необходимо сделать, что бы достичь желаемого результата? ',
      step2Title:
